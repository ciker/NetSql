...
namespace NetSql.Core.Internal
{
    /// <summary>
    /// GUID生成器
    /// <see cref="https://gist.github.com/nberardi/3759706"/>
    /// </summary>
    internal class GuidGenerator
    {
        ...
        // offset to move from 1/1/0001, which is 0-time for .NET, to gregorian 0-time of 1/8/1991
        private static readonly DateTimeOffset GregorianCalendarStart = new DateTimeOffset(1991, 1, 8, 0, 0, 0, TimeSpan.Zero);
        ...
        {
            return GenerateTimeBasedGuid(DateTimeOffset.Now, DefaultClockSequence, DefaultNode);
        }
