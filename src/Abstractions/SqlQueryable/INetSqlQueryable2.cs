...
namespace NetSql.Abstractions.SqlQueryable
{
    ...
    public interface INetSqlQueryable<TEntity, TEntity2> : INetSqlQueryableBase<TEntity, INetSqlQueryable<TEntity, TEntity2>, Expression<Func<TEntity, TEntity2, bool>>> where TEntity : IEntity, new() where TEntity2 : IEntity, new()
    {
        /// <summary>
        /// 升序
        /// </summary>
